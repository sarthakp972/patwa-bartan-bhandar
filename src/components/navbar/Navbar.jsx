  ...
  return (
    <div className="bg-white sticky top-0 z-50">
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-40 lg:hidden" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className={`relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl ${mode === 'dark' ? 'bg-gray-800 text-white' : ''}`}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === 'sarthakpatwa972@gmail.com' && (
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    <span className={`ml-3 block text-base font-medium ${mode === 'dark' ? 'text-white' : 'text-gray-900'}`}>INDIA</span>
                  </a>
                </div>
              </Dialog.Panel>
            </Transition.Child>
      ...
      <header className="relative bg-white">
        <p className={`flex h-10 items-center justify-center bg-pink-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8 ${mode === 'dark' ? 'bg-gray-800' : ''}`}>
          Get free delivery on orders over ₹1000
        </p>
        <nav aria-label="Top" className={`bg-gray-100 px-4 sm:px-6 lg:px-8 shadow-xl ${mode === 'dark' ? 'bg-gray-800 text-white' : ''}`}>
            ...
            <div className="ml-auto flex items-center">
              ...
              <div className="hidden lg:ml-8 lg:flex">
                <a href="#" className="flex items-center">
                  ...
                  <span className={`ml-3 block text-sm font-medium ${mode === 'dark' ? 'text-white' : 'text-gray-700'}`}>INDIA</span>
                </a>
              </div>
              ...
              <div className="ml-4 flow-root lg:ml-6">
                <Link to="/cart" className={`group -m-2 flex items-center p-2 ${mode === 'dark' ? 'text-white' : 'text-gray-700'}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
</svg>
                  <span className="ml-2 text-sm font-medium " style={{ color: mode === 'dark' ? 'white' : '' }}>{cartItem.length}</span>
